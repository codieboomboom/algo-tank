...
void test_list_push_back_peek_pop_back(void) {
    ...
    ASSERT_EQ_INT(push_back(list, 1), SUCCESS);
    expect_front(list, 1);
    expect_back(list, 1);
    expect_size(list, 1);

    ASSERT_EQ_INT(push_back(list, 2), SUCCESS);
    expect_front(list, 1);
    expect_back(list, 2);
    expect_size(list, 2);
    ...
    (void)v;
    ASSERT_EQ_INT(result, ERROR_LIST_IS_EMPTY);
...
void test_list_push_front_clear_reuse_pop_front(void) {
    ...
    ASSERT_EQ_INT(push_front(list, 1), SUCCESS);
    expect_front(list, 1);
    expect_back(list, 1);
    expect_size(list, 1);

    ASSERT_EQ_INT(push_front(list, 2), SUCCESS);
    expect_front(list, 2);
    expect_back(list, 1);
    expect_size(list, 2);
    ...
    /* reuse after clear */
    ASSERT_EQ_INT(push_front(list, 500), SUCCESS);
    expect_front(list, 500);
    expect_back(list, 500);
    expect_size(list, 1);

    ASSERT_EQ_INT(push_front(list, 999), SUCCESS);
